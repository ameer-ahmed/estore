...
<head>
    ...
    <!-- datepicker -->
    <link href="{{asset('dashboard/assets/libs/air-datepicker/css/datepicker.min.css')}}" rel="stylesheet"
          type="text/css"/>

    <!-- jvectormap -->
    <link href="{{asset('dashboard/assets/libs/jqvmap/jqvmap.min.css')}}" rel="stylesheet"/>
    ...
    <!-- App Css-->
    <link href="{{asset('dashboard/assets/css/app'.appDirection().'.min.css')}}" rel="stylesheet"
          type="text/css"/>
        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box">
                    <a href="index.html" class="logo logo-dark">
                                <span class="logo-sm">
                                    <img src="{{asset('dashboard/assets/images/logo-sm-dark.png')}}" alt="" height="22">
                                </span>
                        <span class="logo-lg">
                    ...
                    <a href="index.html" class="logo logo-light">
                                <span class="logo-sm">
                                    <img src="{{asset('dashboard/assets/images/logo-sm-light.png')}}" alt=""
                                         height="22">
                                </span>
                        <span class="logo-lg">
            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item noti-icon waves-effect" id="page-header-flag-dropdown"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                        ...
                        <img class="rounded-circle header-profile-user"
                             src="{{asset('dashboard/assets/images/users/avatar-1.jpg')}}" alt="Header Avatar">
...
<!-- datepicker -->
<script src="{{asset('dashboard/assets/libs/air-datepicker/js/datepicker.min.js')}}"></script>
<script src="{{asset('dashboard/assets/libs/air-datepicker/js/i18n/datepicker.en.js')}}"></script>
...
<!-- Jq vector map -->
<script src="{{asset('dashboard/assets/libs/jqvmap/jquery.vmap.min.js')}}"></script>
<script src="{{asset('dashboard/assets/libs/jqvmap/maps/jquery.vmap.usa.js')}}"></script>
