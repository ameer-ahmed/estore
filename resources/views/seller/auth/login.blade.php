                    ...
                    <div class="col-xl-5 col-sm-8">
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="p-2">
                                    <h5 class="mb-5 text-center">Welcome, Seller!</h5>
                                    @if(session()->has('auth_error'))
                                        <div class="alert alert-danger mb-0" role="alert">{{ session()->get('auth_error') }}</div>
                                    @endif
                                    <form class="form-horizontal" action="{{ route('seller-login') }}" method="post" novalidate>
                                        @csrf
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="custom-control custom-checkbox">
                                                            <input name="remember_me" type="checkbox" class="custom-control-input" id="customControlInline" checked>
