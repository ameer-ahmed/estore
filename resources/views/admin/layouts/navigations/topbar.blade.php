        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item noti-icon waves-effect" id="page-header-flag-dropdown"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="mdi mdi-earth"></i><span
                        class="d-none d-sm-inline-block ml-1">{{ LaravelLocalization::getCurrentLocaleNative() }}</span>
                </button>
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="{{ route('admin-logout') }}"><i class="mdi mdi-logout font-size-16 align-middle mr-1"></i>
                        Logout</a>
                </div>
            </div>
